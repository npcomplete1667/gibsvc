...
const createSolTransferTransaction = async (from_wallet, to_wallet, amount, pay_dev) => {
...
const createSolTransferInstruction = (from_wallet, to_wallet, amount, transactionReference) => {
