...
const processCreateSolTransferTransaction = async (req, resp) => {
    ...
    const base64Transaction = await SolanaPay.createSolTransferTransaction(fromWallet, toWallet, amount);
